...
set(Qt5Scxml_VERSION_STRING 5.15.1)
...
if (NOT TARGET Qt5::Scxml)
    ...
    set(Qt5Scxml_PRIVATE_INCLUDE_DIRS
        "${_qt5Scxml_install_prefix}/include/QtScxml/5.15.1"
        "${_qt5Scxml_install_prefix}/include/QtScxml/5.15.1/QtScxml"
    )
    ...
    foreach(_module_dep ${_Qt5Scxml_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.1 ${_Qt5Scxml_FIND_VERSION_EXACT}
    ...
    _populate_Scxml_target_properties(RELEASE "libQt5Scxml.so.5.15.1" "" FALSE)
