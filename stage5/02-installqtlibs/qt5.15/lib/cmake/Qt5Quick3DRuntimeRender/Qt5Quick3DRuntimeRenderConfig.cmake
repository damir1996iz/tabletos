...
set(Qt5Quick3DRuntimeRender_VERSION_STRING 5.15.1)
...
if (NOT TARGET Qt5::Quick3DRuntimeRender)
    ...
    set(Qt5Quick3DRuntimeRender_PRIVATE_INCLUDE_DIRS
        "${_qt5Quick3DRuntimeRender_install_prefix}/include/QtQuick3DRuntimeRender/5.15.1"
        "${_qt5Quick3DRuntimeRender_install_prefix}/include/QtQuick3DRuntimeRender/5.15.1/QtQuick3DRuntimeRender"
    )
    ...
    foreach(_module_dep ${_Qt5Quick3DRuntimeRender_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.1 ${_Qt5Quick3DRuntimeRender_FIND_VERSION_EXACT}
    ...
    _populate_Quick3DRuntimeRender_target_properties(RELEASE "libQt5Quick3DRuntimeRender.so.5.15.1" "" FALSE)
