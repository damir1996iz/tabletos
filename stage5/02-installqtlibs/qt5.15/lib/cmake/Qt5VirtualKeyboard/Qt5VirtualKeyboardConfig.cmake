...
set(Qt5VirtualKeyboard_VERSION_STRING 5.15.1)
...
if (NOT TARGET Qt5::VirtualKeyboard)
    ...
    set(Qt5VirtualKeyboard_PRIVATE_INCLUDE_DIRS
        "${_qt5VirtualKeyboard_install_prefix}/include/QtVirtualKeyboard/5.15.1"
        "${_qt5VirtualKeyboard_install_prefix}/include/QtVirtualKeyboard/5.15.1/QtVirtualKeyboard"
    )
    ...
    foreach(_module_dep ${_Qt5VirtualKeyboard_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.1 ${_Qt5VirtualKeyboard_FIND_VERSION_EXACT}
    ...
    _populate_VirtualKeyboard_target_properties(RELEASE "libQt5VirtualKeyboard.so.5.15.1" "" FALSE)
