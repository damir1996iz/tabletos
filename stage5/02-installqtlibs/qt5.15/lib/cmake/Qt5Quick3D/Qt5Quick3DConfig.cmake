...
set(Qt5Quick3D_VERSION_STRING 5.15.1)
...
if (NOT TARGET Qt5::Quick3D)
    ...
    set(Qt5Quick3D_PRIVATE_INCLUDE_DIRS
        "${_qt5Quick3D_install_prefix}/include/QtQuick3D/5.15.1"
        "${_qt5Quick3D_install_prefix}/include/QtQuick3D/5.15.1/QtQuick3D"
    )
    ...
    foreach(_module_dep ${_Qt5Quick3D_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.1 ${_Qt5Quick3D_FIND_VERSION_EXACT}
    ...
    _populate_Quick3D_target_properties(RELEASE "libQt5Quick3D.so.5.15.1" "" FALSE)
