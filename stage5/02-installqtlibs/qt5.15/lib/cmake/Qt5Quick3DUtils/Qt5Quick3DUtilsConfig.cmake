...
set(Qt5Quick3DUtils_VERSION_STRING 5.15.1)
...
if (NOT TARGET Qt5::Quick3DUtils)
    ...
    set(Qt5Quick3DUtils_PRIVATE_INCLUDE_DIRS
        "${_qt5Quick3DUtils_install_prefix}/include/QtQuick3DUtils/5.15.1"
        "${_qt5Quick3DUtils_install_prefix}/include/QtQuick3DUtils/5.15.1/QtQuick3DUtils"
    )
    ...
    foreach(_module_dep ${_Qt5Quick3DUtils_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.1 ${_Qt5Quick3DUtils_FIND_VERSION_EXACT}
    ...
    _populate_Quick3DUtils_target_properties(RELEASE "libQt5Quick3DUtils.so.5.15.1" "" FALSE)
