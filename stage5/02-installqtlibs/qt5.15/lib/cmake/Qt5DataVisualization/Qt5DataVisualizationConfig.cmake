...
set(Qt5DataVisualization_VERSION_STRING 5.15.1)
...
if (NOT TARGET Qt5::DataVisualization)
    ...
    set(Qt5DataVisualization_PRIVATE_INCLUDE_DIRS
        "${_qt5DataVisualization_install_prefix}/include/QtDataVisualization/5.15.1"
        "${_qt5DataVisualization_install_prefix}/include/QtDataVisualization/5.15.1/QtDataVisualization"
    )
    ...
    foreach(_module_dep ${_Qt5DataVisualization_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.1 ${_Qt5DataVisualization_FIND_VERSION_EXACT}
    ...
    _populate_DataVisualization_target_properties(RELEASE "libQt5DataVisualization.so.5.15.1" "" FALSE)
