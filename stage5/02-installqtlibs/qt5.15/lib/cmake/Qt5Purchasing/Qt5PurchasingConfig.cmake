...
set(Qt5Purchasing_VERSION_STRING 5.15.1)
...
if (NOT TARGET Qt5::Purchasing)
    ...
    set(Qt5Purchasing_PRIVATE_INCLUDE_DIRS
        "${_qt5Purchasing_install_prefix}/include/QtPurchasing/5.15.1"
        "${_qt5Purchasing_install_prefix}/include/QtPurchasing/5.15.1/QtPurchasing"
    )
    ...
    foreach(_module_dep ${_Qt5Purchasing_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.1 ${_Qt5Purchasing_FIND_VERSION_EXACT}
    ...
    _populate_Purchasing_target_properties(RELEASE "libQt5Purchasing.so.5.15.1" "" FALSE)
